...
/**
 * @see https://github.com/inversify/InversifyJS/blob/master/wiki/named_bindings.md
 */
...
/**
 * @see https://github.com/inversify/InversifyJS/blob/master/wiki/tagged_bindings.md
 */
...
/**
 * uses container.getAllNamed()
 * @see https://github.com/inversify/InversifyJS/blob/master/wiki/container_api.md#containergetallnamed
 * @see https://github.com/inversify/InversifyJS/blob/master/wiki/named_bindings.md
 */
